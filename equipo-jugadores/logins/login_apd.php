...
<!--form-->
          ...
          <form action="mod_validar_apd.php" method="post">
                <center>
                ...
                <div class="card-body">
                  ...
                  <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Email del Apadrinador</label>
                <input style="width: 270px" type="email" class="form-control" name="email_name" placeholder="Ingrese su Email de apadrinador" required>
              </div>
              <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Codigo Unico De Apadrinador</label>
                <input style="width: 270px" type="password" class="form-control" name="unic_code_name" placeholder="Codigo Unico" required>
              </div>
            <div>
              <button type="submit" class="btn btn-primary"  value="Log In" >Login!</button>
            </div>
              <div>
                               <a style="padding-left: 300px;" href="../formularios/form_post.php">Registrate!</a>  
                               <a style="padding-left: 265px;" href="login_post.php">Soy Postulante!</a> 
               </div>   
            </center>
                </div>
              </div>
