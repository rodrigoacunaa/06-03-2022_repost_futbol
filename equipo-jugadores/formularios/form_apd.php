        ...
        <div class="row">
          ...
          <div class="col-md-12 col-lg-8 mb-5">
            <form action="modulo_apd.php" class="p-5 bg-white border" method="post">
              ...
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="fullname">Club representante</label>
                  <input type="password" id="club_rep_id" name="club_rep_name" class="form-control" placeholder="Club representante" required="">
                </div>
              </div>
