      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12 col-lg-8 mb-5">
            <form action="../modulos/modulo_postulante.php" class="p-5 bg-white border" method="post">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <input type="number" id="dni_id" name="dni_name" class="form-control" placeholder="Dni del jugador postulante" required="">
                </div>
              </div>
