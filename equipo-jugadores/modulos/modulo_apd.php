...
// echo "funciona";
	$conexion = conectame();
			...
			mysqli_query($conexion, "INSERT INTO `apd`(`estado_apd`, `user`, `password`, `telefono`, `mail`, `entidad_social`, `nombre_apd`, `apellido_apd`, `codigo_unico`, `club_rep`) VALUES ('".$valor_1."', '".$valor_2."', '".$valor_3."', '".$valor_4."', '".$valor_5."', '".$valor_6."', '".$valor_7."', '".$valor_8."', '".$valor_9."', '".$valor_10."')");
